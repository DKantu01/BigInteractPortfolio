      ...
      tabPanel(tags$h1("Step 3 - Experiment"),
               ...
               sidebarLayout(
                 sidebarPanel(
                   ...
                   fluidRow(
                     column(4, checkboxGroupInput("cbg", "from list below", c("Project 1"="1","Project 2"="2","Project 3"="3","Project 4"="4","Project 5"="5","Project 6"="6","Project 7"="7","Project 8"="8","Project 9"="9","Project 10"="10"))),
