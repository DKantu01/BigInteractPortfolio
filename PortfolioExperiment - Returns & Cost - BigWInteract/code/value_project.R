...
project<-numbers
n1<-length(project)
var.names<-c('Project1', 'Project2', 'Project3','Project4','Project5','Project6','Project7','Project8','Project9','Project10')
#var.names<-c('Project 1', 'Project 2', 'Project 3','Project 4','Project 5','Project 6','Project 7','Project 8','Project 9','Project 10')
n<-length(var.names)
maxWeight<-280


pval<-matrix(c(100,150,120,210,80,180,110,150,40,40),ncol=n,nrow=1)
#pval<-matrix(c(30,50,140,40,200,170,60,150,50,100),ncol=n,nrow=1)
wval<-matrix(c(60,100,40,90,40,100,40,60,80,40),ncol=n,nrow=1)
